import { Box, Divider, makeStyles, Paper, Typography, useMediaQuery } from "@material-ui/core";
...
import { formatRealtimePredictionData } from "../../common/utils";
			...
			<Paper variant='outlined' style={{ borderRadius: 10, padding: 20, paddingTop: 20, width: '100%', paddingBottom: 0 }}>
				...
				<Box mt={1} width='100%' height={188}>
					...
					<ResponsiveContainer width='100%' height='100%'>
						<LineChart data={formatRealtimePredictionData(dummyData, date)} className={classes.graph} >
